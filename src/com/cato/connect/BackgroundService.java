...
import com.cato.connect.Backends.BaseLink;
import com.cato.connect.Backends.BaseLinkProvider;
import com.cato.connect.Backends.LanBackend.LanLinkProvider;
import com.cato.connect.Helpers.NotificationHelper;
import com.cato.connect.Helpers.SecurityHelpers.RsaHelper;
import com.cato.connect.Helpers.SecurityHelpers.SslHelper;
import com.cato.connect.Helpers.ThreadHelper;
//import com.cato.connect.Plugins.ClibpoardPlugin.ClipboardFloatingActivity;
import com.cato.connect.Plugins.Plugin;
import com.cato.connect.Plugins.PluginFactory;
//import com.cato.connect.Plugins.RunCommandPlugin.RunCommandActivity;
//import com.cato.connect.Plugins.RunCommandPlugin.RunCommandPlugin;
//import com.cato.connect.Plugins.SharePlugin.SendFileActivity;
...
//import com.cato.connect.Backends.BluetoothBackend.BluetoothLinkProvider;
...
//        linkProviders.add(new BluetoothLinkProvider(this));
    ...
    private Notification createForegroundNotification() {
        ...
        if (connectedDevices.isEmpty()) {
            ...
            /* removed by cato if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P &&
            ...
            if (connectedDeviceIds.size() == 1) {
                ...
                if (device != null) {
                    ...
                    */
                    ...
                    /* commented out by cato RunCommandPlugin plugin = (RunCommandPlugin) device.getPlugin("RunCommandPlugin");
