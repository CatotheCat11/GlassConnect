...
package com.cato.connect.Backends.LanBackend;
...
import com.cato.connect.Helpers.TrustedNetworkHelper;
import com.cato.connect.NetworkPacket;
import com.cato.connect.UserInterface.CustomDevicesActivity;
...
public class LanLinkProvider extends BaseLinkProvider implements LanLink.LinkDisconnectedCallback {
    ...
    private void tcpPacketReceived(Socket socket) {
        ...
        try {
            ...
            Log.d("TcpListener","Received TCP packet: " + networkPacket.serialize());
        } catch (Exception e) {
            ...
            ThreadHelper.execute(() -> {
                try {
                    ...
                    for (String cipher : ciphers) {
                        Log.d("SupportedCiphers","cipher: " + cipher);
                    }
                }
            });
        } catch (Exception e) {
    ...
    /**
     * Add or update a link in the {@link #visibleDevices} map. This method is synchronized, which ensures that only one
