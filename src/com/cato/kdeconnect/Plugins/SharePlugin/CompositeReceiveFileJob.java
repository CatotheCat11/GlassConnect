...
import com.cato.kdeconnect.Helpers.MediaStoreHelper;
...
public class CompositeReceiveFileJob extends BackgroundJob<Device, Void> {
    ...
    private void openFile(DocumentFile fileDocument) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri contentUri = FileProvider.getUriForFile(getDevice().getContext(), "com.cato.kdeconnect.fileprovider", file);
